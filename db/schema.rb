...
ActiveRecord::Schema[7.1].define(version: 2024_06_07_181329) do
  ...
  create_table "highlights", charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    t.bigint "profile_id", null: false
  ...
  create_table "interests", charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    t.bigint "profile_id", null: false
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
